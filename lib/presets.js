...
const PRESETS = [
  {
    ...
    getKeyframes(coordinates, cw, ch, duration, scene) {
      ...
      const zoomT = Math.min(0.9, zoomDuration / (duration || 4));
      const holdT = Math.min(0.95, zoomT + 0.1);
      return [
        { time: 0, scale: 1.0, overlayType: 'none', overlayProgress: 0 },
        { time: zoomT, scale: zoomLevel, overlayType: 'none', overlayProgress: 0 },
  ...
  },
  {
    ...
    getKeyframes(coordinates, cw, ch, duration, scene) {
      ...
      return [
        { time: 0, scale: zoomLevel, overlayType: 'none', overlayProgress: 0 },
        { time: zoomT, scale: zoomLevel, overlayType: 'none', overlayProgress: 0 },
        { time: holdT, scale: zoomLevel, overlayType: 'highlight', overlayProgress: 0 },
  ...
  },
  {
    ...
    getKeyframes(coordinates, cw, ch, duration, scene) {
      ...
      return [
        { time: 0, scale: zoomLevel, overlayType: 'none', overlayProgress: 0 },
        { time: zoomT, scale: zoomLevel, overlayType: 'word', overlayProgress: 0 },
  ...
  },
  {
    ...
    getKeyframes(coordinates, cw, ch, duration, scene) {
      ...
      const zoomT = Math.min(0.9, zoomDuration / (duration || 4));
      return [
        { time: 0, scale: zoomLevel, overlayType: 'magnifier', overlayProgress: 0 },
        { time: zoomT, scale: zoomLevel, overlayType: 'magnifier', overlayProgress: 0 },
  ...
  },
  {
    ...
    getKeyframes(coordinates, cw, ch, duration, scene) {
      ...
      const zoomT = Math.min(0.9, zoomDuration / (duration || 4));
      return [
        { time: 0, scale: zoomLevel, overlayType: 'redline', overlayProgress: 0 },
        { time: zoomT, scale: zoomLevel, overlayType: 'redline', overlayProgress: 0.5 },
  ...
  },
  {
    ...
    getKeyframes(coordinates, cw, ch, duration, scene) {
      ...
      return [
        ...
        { time: zoomT, scale: 1.0, overlayType: 'pointer', overlayProgress: 0.6 },
